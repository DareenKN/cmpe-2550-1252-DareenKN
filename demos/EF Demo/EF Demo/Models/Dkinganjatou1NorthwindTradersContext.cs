...
public partial class Dkinganjatou1NorthwindTradersContext : DbContext
{
    public Dkinganjatou1NorthwindTradersContext()
    {
    }

    public Dkinganjatou1NorthwindTradersContext(DbContextOptions<Dkinganjatou1NorthwindTradersContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=data.cnt.sast.ca,24680;Database=dkinganjatou1_NorthwindTraders;User Id=dkinganjatou1;Password=NaitKid181; Encrypt=False;");
