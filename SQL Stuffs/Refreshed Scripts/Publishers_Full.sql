...
raiserror('Beginning InstPublishers.SQL at %s ....',1,1,@dttm) with nowait

GO

if exists (select * from sysdatabases where name='Publishers')
begin
  raiserror('Dropping existing Publishers database ....',0,1)
  DROP database Publishers
end
GO

raiserror('Creating Publishers database....',0,1)
go
/*
...
if db_name() <> 'Publishers'
   raiserror('Error in InstPublishers.SQL, ''USE Publishers'' failed!  Killing the SPID now.'
            ,22,127) with log
...
'This is sample text data for New Moon Books, publisher 0736 in the Publishers database. New Moon Books is located in Boston, Massachusetts.
...
'This is sample text data for Binnet & Hardley, publisher 0877 in the Publishers database. Binnet & Hardley is located in Washington, D.C.
...
'This is sample text data for Algodata Infosystems, publisher 1389 in the Publishers database. Algodata Infosystems is located in Berkeley, California.
...
'This is sample text data for Five Lakes Publishing, publisher 1622 in the Publishers database. Five Lakes Publishing is located in Chicago, Illinois.
...
'This is sample text data for Ramona Publishers, publisher 1756 in the Publishers database. Ramona Publishers is located in Dallas, Texas.')
...
'This is sample text data for GGG&G, publisher 9901 in the Publishers database. GGG&G is located in M�nchen, Germany.')
...
'This is sample text data for Scootney Books, publisher 9952 in the Publishers database. Scootney Books is located in New York City, New York.')
...
'This is sample text data for Lucerne Publishing, publisher 9999 in the Publishers database. Lucerne publishing is located in Paris, France.
...
declare @dttm varchar(55)
select  @dttm=convert(varchar,getdate(),113)
raiserror('Ending InstPublishers.SQL at %s ....',1,1,@dttm) with nowait
