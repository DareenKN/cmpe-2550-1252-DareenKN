...
raiserror('Beginning Instdkinganjatou1_pubs.SQL at %s ....',1,1,@dttm) with nowait

GO

if exists (select * from sysdatabases where name='dkinganjatou1_pubs')
begin
  raiserror('Dropping existing dkinganjatou1_pubs database ....',0,1)
  DROP database dkinganjatou1_pubs
end
GO

raiserror('Creating dkinganjatou1_pubs database....',0,1)
go
/*
   Use default size with autogrow
*/

CREATE DATABASE dkinganjatou1_pubs
GO
...
if db_name() <> 'dkinganjatou1_pubs'
   raiserror('Error in Instdkinganjatou1_pubs.SQL, ''USE dkinganjatou1_pubs'' failed!  Killing the SPID now.'
            ,22,127) with log

GO

alter database dkinganjatou1_pubs set recovery simple 
GO

raiserror('Now at the user defined type creation section ....',0,1)
GO

if not exists (select name from systypes where name = 'id')
	execute sp_addtype id      ,'varchar(11)' ,'NOT NULL'

if not exists (select name from systypes where name = 'tid')
	execute sp_addtype tid     ,'varchar(6)'  ,'NOT NULL'

if not exists (select name from systypes where name = 'empid')
	execute sp_addtype empid   ,'char(9)'     ,'NOT NULL'
GO

raiserror('Now at the drop table section ....',0,1)
GO

if exists (select name from sysobjects where name = 'discounts')
	drop table discounts
GO
if exists (select name from sysobjects where name = 'employee')
	drop table employee
GO
if exists (select name from sysobjects where name = 'jobs')
	drop table jobs
GO
if exists (select name from sysobjects where name = 'roysched')
	drop table roysched
GO
if exists (select name from sysobjects where name = 'titleauthor')
	drop table titleauthor
GO
if exists (select name from sysobjects where name = 'authors')
	drop table authors
GO
if exists (select name from sysobjects where name = 'pub_info')
	drop table pub_info
GO
...
if exists (select name from sysobjects where name = 'titles')
	drop table titles
GO
if exists (select name from sysobjects where name = 'publishers')
	drop table publishers
GO
if exists (select name from sysobjects where name = 'stores')
	drop table stores
GO
...
'This is sample text data for New Moon Books, publisher 0736 in the dkinganjatou1_pubs database. New Moon Books is located in Boston, Massachusetts.
...
'This is sample text data for Binnet & Hardley, publisher 0877 in the dkinganjatou1_pubs database. Binnet & Hardley is located in Washington, D.C.
...
'This is sample text data for Algodata Infosystems, publisher 1389 in the dkinganjatou1_pubs database. Algodata Infosystems is located in Berkeley, California.
...
'This is sample text data for Five Lakes Publishing, publisher 1622 in the dkinganjatou1_pubs database. Five Lakes Publishing is located in Chicago, Illinois.
...
'This is sample text data for Ramona Publishers, publisher 1756 in the dkinganjatou1_pubs database. Ramona Publishers is located in Dallas, Texas.')
...
'This is sample text data for GGG&G, publisher 9901 in the dkinganjatou1_pubs database. GGG&G is located in M�nchen, Germany.')
...
'This is sample text data for Scootney Books, publisher 9952 in the dkinganjatou1_pubs database. Scootney Books is located in New York City, New York.')
...
'This is sample text data for Lucerne Publishing, publisher 9999 in the dkinganjatou1_pubs database. Lucerne publishing is located in Paris, France.
...
raiserror('Now at the drop view section ....',0,1)
GO

if exists (select name from sysobjects where name = 'titleview')
	drop view titleview
GO
...
raiserror('Now at the drop procedure section ....',0,1)
GO

if exists (select name from sysobjects where name = 'byroyalty')
	drop procedure byroyalty
GO
if exists (select name from sysobjects where name = 'reptq1')
	drop procedure reptq1
GO
if exists (select name from sysobjects where name = 'reptq2')
	drop procedure reptq2
GO
if exists (select name from sysobjects where name = 'reptq3')
...
declare @dttm varchar(55)
select  @dttm=convert(varchar,getdate(),113)
raiserror('Ending Instdkinganjatou1_pubs.SQL at %s ....',1,1,@dttm) with nowait
