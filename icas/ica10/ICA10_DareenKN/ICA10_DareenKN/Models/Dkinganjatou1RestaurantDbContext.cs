...
namespace ICA10_DareenKN.Models;

public partial class Dkinganjatou1RestaurantDbContext : DbContext
{
    public Dkinganjatou1RestaurantDbContext()
    {
    }

    public Dkinganjatou1RestaurantDbContext(DbContextOptions<Dkinganjatou1RestaurantDbContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=data.cnt.sast.ca,24680;Database=dkinganjatou1_RestaurantDB;User Id=dkinganjatou1;Password=NaitKid181; Encrypt=False;");
